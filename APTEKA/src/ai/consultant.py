...
16. Если клиент спрашивает про "где вы", "адрес", "как добраться", "режим работы", "телефон", "когда работаете", "контакты", "оплату" — отвечай данными из блока "ИНФОРМАЦИЯ ОБ АПТЕКЕ" (если он есть в контексте).
...
3. Симптомы, info-вопросы (как принимать, побочные, детям), вопросы про аптеку (адрес, часы, оплата, подписки) — всегда "none".
        ...
        try:
            ...
            sys_msgs = [{
                ...
                "content": (
                    ...
                    "симптомам, наличие и цена, аналоги, адрес/часы).\n"
